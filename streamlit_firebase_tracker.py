...
def calculate_revenue_with_kg(buyer_allocation, prices):
    """Calculate revenue based on buyer allocation and prices (RM per kg, 1 bakul = 15kg)"""
    revenue_summary = {}
    total_revenue = 0
        ...
        if buyer in buyer_allocation:
            for size in FRUIT_SIZES:
                if size in buyer_allocation[buyer] and size in prices[buyer]:
                    ...
                    price_per_kg = prices[buyer][size]
